...
{% code overflow="wrap" %}
```
"Block Type" -> "NodeBlock.Engine.Nodes.Data.SendDataToWebhookNode""Description" -> "Send data parameters as JSON to the url specified"
"Block Gas Cost" -> 0
```
{% endcode %}
...
<pre data-overflow="wrap"><code>"Block Type" -> "NodeBlock.Plugin.Messaging.Nodes.Telegram.SendTelegramMessageNode"
